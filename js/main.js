...
const filtered = sorted.filter(item => item.splited_word !== "and" && item.splited_word !== 'an' && item.splited_word.length >= 2);
console.log("this is filtered frequency", filtered);